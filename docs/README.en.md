...
| API contracts | [Core](api/core.en.md) · [Desktop](api/desktop.en.md) · [Task Mode and channels](api/tasks.en.md) · [Runtime](api/runtime.en.md) · [TypeScript SDKs](api/typescript-sdk.en.md) · [Native Host](api/native-host.en.md) · [Claude CLI](api/claude-cli.en.md) · [Local services](api/local-service.en.md) |
