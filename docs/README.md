...
| API 契约 | [Core](api/core.md) · [桌面 API](api/desktop.md) · [Runtime](api/runtime.md) · [TypeScript SDK](api/typescript-sdk.md) · [Native Host](api/native-host.md) · [Claude CLI](api/claude-cli.md) · [本地服务](api/local-service.md) |
